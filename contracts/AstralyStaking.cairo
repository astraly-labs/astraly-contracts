...
@event
func WithdrawLP(
    caller: felt, receiver: felt, owner: felt, lp_token: felt, assets: Uint256, shares: Uint256
) {
}
...
@view
func endBlock{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (block: felt) {
...
func get_tokens_addresses_from_mask{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr, bitwise_ptr: BitwiseBuiltin*
}(position: felt, bit_mask: felt, tokens_allocation_index: felt, array: felt*) -> (length: felt) {
    alloc_locals;
    if (bit_mask == 0) {
...
func assert_not_before_unlock_time{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    user: felt
) {
...
func calculate_withdraw_lp_amount{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    owner: felt, lp_token: felt, sharesAmount: Uint256
) -> (amount: Uint256) {
    return (sharesAmount,);
}
...
func update_user_info_on_withdraw{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    user: felt, assets: Uint256
) {
    alloc_locals;
    let (cur_user_info: UserInfo) = userInfo(user);
