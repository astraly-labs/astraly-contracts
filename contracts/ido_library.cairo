...
@storage_var
func IDO_vesting_portions_unlock_time_array(i: felt) -> (res: felt) {
}

// Percent of the participation user can withdraw
@storage_var
func IDO_vesting_percent_per_portion_array(i: felt) -> (res: Uint256) {
}

@storage_var
func IDO_number_of_vesting_portions() -> (res: felt) {
}

// Precision for percent for portion vesting
@storage_var
func IDO_portion_vesting_precision() -> (res: Uint256) {
}

// Max vesting time shift
@storage_var
func IDO_max_vesting_time_shift() -> (res: felt) {
}
...
namespace IDO {
    ...
    func get_user_info{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        alloc_locals;
        let (_participation) = IDO_user_to_participation.read(account);
        let (_allocations) = IDO_address_to_allocations.read(account);
    ...
    func get_vesting_percent_per_portion_array{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    }(portion_id: felt) -> (res: Uint256) {
        let (res: Uint256) = IDO_vesting_percent_per_portion_array.read(portion_id);
        return (res=res);
    }

    func get_vesting_portions_unlock_time_array{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    }(portion_id: felt) -> (res: felt) {
        let (unlock_time) = IDO_vesting_portions_unlock_time_array.read(portion_id);
    ...
    func get_number_of_vesting_portions{
        ...
        let (nbr_of_portions) = IDO_number_of_vesting_portions.read();
    ...
    func set_vesting_params{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        let (local _portion_vesting_precision: Uint256) = IDO_portion_vesting_precision.read();
        with_attr error_message(
        ...
        IDO_max_vesting_time_shift.write(_max_vesting_time_shift);
        IDO_number_of_vesting_portions.write(_percents_len);
    ...
    func set_sale_params{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        IDO_portion_vesting_precision.write(_portion_vesting_precision);
        // emit event
        SaleCreated.emit(
    ...
    func _participate{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        IDO_user_to_participation.write(account, new_purchase);
    ...
    func withdraw_tokens{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        let (vesting_portions_unlock_time) = IDO_vesting_portions_unlock_time_array.read(
            portion_id
        );
        ...
        let (vesting_portion_percent) = get_vesting_percent_per_portion_array(portion_id);

        with_attr error_message(
                "AstralyIDOContract::withdraw_tokens invlaid vestion portion percent") {
        ...
        IDO_user_to_participation.write(address_caller, participation_upd);

        let (amt_withdrawing_num: Uint256) = SafeUint256.mul(
            participation.amount_bought, vesting_portion_percent
        );
        let (portion_vesting_prsn: Uint256) = IDO_portion_vesting_precision.read();
    ...
    func withdraw_multiple_portions{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    ...
    func withdraw_multiple_portions_rec{
        ...
        let (participation) = IDO_user_to_participation.read(_address_caller);
        with_attr error_message(
        ...
        IDO_user_to_participation.write(_address_caller, participation_upd);
        ...
        let (vesting_portion_percent) = get_vesting_percent_per_portion_array(current_portion);
        with_attr error_message(
    ...
    func populate_vesting_params_rec{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    }(
        _unlocking_times_len: felt,
        _unlocking_times: felt*,
        ...
        IDO_vesting_portions_unlock_time_array.write(_array_index, _unlocking_times[0]);
        IDO_vesting_percent_per_portion_array.write(_array_index, _percents[0]);
